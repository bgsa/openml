...
namespace OpenMLTest
{
	...
	public:
		...
		{
			Line3Df line1 = Line3Df( Point3Df{ 6.0f, 8.0f, 4.0f }, Point3Df{ 12.0f, 15.0f, 4.0f });
			Line3Df line2 = Line3Df( Point3Df{ 6.0f, 8.0f, 2.0f }, Point3Df{ 12.0f, 15.0f, 6.0f });
			
			Point3Df expected = { 9.0f, 11.5f, 4.0f };

			Point3Df* result = line1.findIntersection(line2);
